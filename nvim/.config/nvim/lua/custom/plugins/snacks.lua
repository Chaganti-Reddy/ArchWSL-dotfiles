...
return {
  ...
  keys = {
    ...
    {
      '<leader>tn',
      function() Snacks.toggle.line_number():toggle() end,
    ...
    {
      '<leader>tb',
      function() Snacks.toggle.line_blame():toggle() end,
    ...
    {
      '<leader>tr',
      function() Snacks.toggle.option('conceallevel', { off = 0, on = 2, name = 'Conceal' }):toggle() end,
