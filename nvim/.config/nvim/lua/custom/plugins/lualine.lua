  ...
  config = function()
    ...
    local function harpoon_status()
      ...
      for i, item in ipairs(list.items) do
        ...
        if full_path == current_file then return '󰀱 ' .. i end
      end
      return ''
    end
    ...
    local function treesitter_status()
      ...
      if vim.treesitter.highlighter.active[b] then return ' TS' end
      return ''
    end
    ...
    local function diagnostic_stats()
      ...
      for _, level in ipairs(levels) do
        ...
        if n > 0 then table.insert(res, level.sym .. n) end
      end
    ...
    vim.api.nvim_create_autocmd('RecordingLeave', {
      callback = function()
        vim.defer_fn(function() lualine.refresh() end, 50)
      end,
    })
  end,
}
